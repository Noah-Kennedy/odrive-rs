...
fn test_startup_calibration_setter() {
    ...
    odrive.set_startup_motor_calibration(MotorAxis::Zero, true).unwrap();
...
fn test_startup_encoder_index_search_setter() {
    let mut odrive = init_odrive();
    odrive.set_startup_encoder_index_search(MotorAxis::Zero, true).unwrap();
...
fn test_startup_encoder_offset_calibration_setter() {
    let mut odrive = init_odrive();
    odrive.set_startup_encoder_offset_calibration(MotorAxis::Zero, true).unwrap();
...
fn test_startup_closed_loop_control_setter() {
    let mut odrive = init_odrive();
    odrive.set_startup_closed_loop_control(MotorAxis::Zero, true).unwrap();
...
fn test_startup_sensorless_control_setter() {
    let mut odrive = init_odrive();
    odrive.set_startup_sensorless_control(MotorAxis::Zero, true).unwrap();
